	...
	public function edit_Goods($data){
		$error=$this->validate($data);
			...
			if($r){					
				...
				$goods_description['summary'] =str_replace('\"','"',$data['goods_description']['summary'] );
				$goods_description['summary'] =str_replace("/<(.*?)>/",'',htmlspecialchars_decode($data['goods_description']['summary']));

				// $goods_description['description']=$data['goods_description']['description'];
				$goods_description['description'] =str_replace('\"','"',$data['goods_description']['description'] );
				$goods_description['description'] =str_replace("/<(.*?)>/",'',htmlspecialchars_decode($data['goods_description']['description']));
