        ...
        <div class="containerr">
            <div class="row">
                ...
                <div class="col-md-8 col-lg-8">
                    <article class="text">
                        <h3><?php echo ($file[0]["title"]); ?></h3>
                        <h4>Company profile</h4>
                        <hr>
                        <h4>
                            <?php echo ($file[0]["content"]); ?>
                        </h4>
                    </article>
                </div>
                <div class="col-md-2 col-lg-2"></div>
            </div>
            <div class="row ico-png">
            <div class="col-md-3 col-lg-3"></div>
                <?php if(is_array($file)): $i = 0; $__LIST__ = $file;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(is_array($vo["lv2"])): $i = 0; $__LIST__ = $vo["lv2"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;?><div class="col-md-3 col-lg-3"><img src="/theguide/uploads/image/<?php echo ($vv["image"]); ?>" alt=""></div><?php endforeach; endif; else: echo "" ;endif; endforeach; endif; else: echo "" ;endif; ?>
            <div class="col-md-3 col-lg-3"></div>
            </div>
        </div>
    </div>
    ...
    <div class="distribution">
        ...
        <ul class="clearfix">
            <li>
                ...
                <img src="/theguide/Themes/Home/default/Public/images/distri_li1.jpg" alt="">
                <dd>
                    <h6>上海</h6>
                    <h5>021-63353683</h5>
                    <p><span>地址：</span>上海市黄浦区龙华东路858号海外滩中心办公室B座603-604</p>
                </dd>
            </li>
            <li>
                <img src="/theguide/Themes/Home/default/Public/images/distri_li2.jpg" alt="">
                <dd>
                    <h6>无锡</h6>
                    <h5>0510-66926188</h5>
                    <p><span>地址：</span>无锡滨湖区鸿桥路无锡现代国际工业设计大厦912-918</p>
                </dd>
            </li>
            <li>
                <img src="/theguide/Themes/Home/default/Public/images/distri_li3.jpg" alt="">
                <dd>
                    <h6>济南</h6>
                    <h5>021-63353683</h5>
                    <p><span>地址：</span>济南市槐荫区绿地中央广场A座1201,1210-1212</p>
                </dd>
            </li>
            <li>
                <img src="/theguide/Themes/Home/default/Public/images/distri_li4.jpg" alt="">
                <dd>
                    <h6>上海</h6>
                    <h5>021-63353683</h5>
                    <p><span>地址：</span>上海市黄浦区龙华东路858号海外滩中心办公室B座603-604</p>
