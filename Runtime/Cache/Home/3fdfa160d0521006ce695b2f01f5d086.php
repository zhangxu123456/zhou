...
<div class="main question">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 col-lg-4 text-center"><h2>常见问题</h2></div>
            <div class="col-md-4 col-lg-4"></div>
            <div class="col-md-1 col-lg-1"></div>
            <div class="col-md-10 col-lg-10">
                <div class="wpb_wrapper">
                    <?php if(is_array($ques)): $i = 0; $__LIST__ = $ques;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><h5 class="<?php echo $key == 0 ? 'active' : '' ;?>">
                            <span class="accordion_mark left_mark"></span>
                            <span class="tab-title"><?php echo ($vo["title"]); ?></span>
                        </h5>
...
<script src="/theguide/Common/bt/js/bootstrap.min.js"></script>
<script src="/theguide/Themes/Home/default/Public/js/question.js"></script>
</body>
</html>