...
<div class="row">
	<div class="col-xs-12">	
		<form class="form-horizontal"  id="form" method="post" action="<?php echo U('Settings/save');?>">	
			...
			<div class="col-sm-10">
				<div class="clearfix">
					<input name="SMTP_HOST" class="col-xs-10 col-sm-5"  value="<?php echo ((isset($smtp["SMTP_HOST"]["value"]) && ($smtp["SMTP_HOST"]["value"] !== ""))?($smtp["SMTP_HOST"]["value"]):''); ?>" type="text">
				</div>
			</div>
			</div>
			...
			<div class="col-sm-10">
				<div class="clearfix">
					<input name="SMTP_PORT" class="col-xs-10 col-sm-5"  value="<?php echo ((isset($smtp["SMTP_PORT"]["value"]) && ($smtp["SMTP_PORT"]["value"] !== ""))?($smtp["SMTP_PORT"]["value"]):''); ?>" type="text">
				</div>
			</div>
			</div>
			
			<div class="form-group">
				<label class="col-sm-2 control-label no-padding-left"> * SMTP服务器用户名 </label>
			<div class="col-sm-10">
				<div class="clearfix">
					<input name="SMTP_USER" class="col-xs-10 col-sm-5"  value="<?php echo ((isset($smtp["SMTP_USER"]["value"]) && ($smtp["SMTP_USER"]["value"] !== ""))?($smtp["SMTP_USER"]["value"]):''); ?>" type="text">
				</div>
			</div>
			</div>
			
			<div class="form-group">
				<label class="col-sm-2 control-label no-padding-left"> * SMTP服务器密码 </label>
			<div class="col-sm-10">
				<div class="clearfix">
					<input name="SMTP_PASS" class="col-xs-10 col-sm-5"  value="<?php echo ((isset($smtp["SMTP_PASS"]["value"]) && ($smtp["SMTP_PASS"]["value"] !== ""))?($smtp["SMTP_PASS"]["value"]):''); ?>" type="text">
				</div>
			</div>
			</div>
			
			<div class="form-group">
				<label class="col-sm-2 control-label no-padding-left"> * 发件人EMAIL </label>
			<div class="col-sm-10">
				<div class="clearfix">
					<input name="FROM_EMAIL" class="col-xs-10 col-sm-5"  value="<?php echo ((isset($smtp["FROM_EMAIL"]["value"]) && ($smtp["FROM_EMAIL"]["value"] !== ""))?($smtp["FROM_EMAIL"]["value"]):''); ?>" type="text">
				</div>
			</div>
			</div>
			...
			<div class="col-sm-10">
				<div class="clearfix">
					<input name="FROM_NAME" class="col-xs-10 col-sm-5"  value="<?php echo ((isset($smtp["FROM_NAME"]["value"]) && ($smtp["FROM_NAME"]["value"] !== ""))?($smtp["FROM_NAME"]["value"]):''); ?>" type="text">
				</div>
			</div>
			</div>
