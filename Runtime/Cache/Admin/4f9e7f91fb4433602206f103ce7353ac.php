...
<a href="<?php echo U('Config/add');?>" class="btn btn-primary">新增</a>

</div>		
	
<table class="table table-striped table-bordered table-hover search-form">
	<thead>
		<th><input name="name" type="text" placeholder="输入配置名称" value="<?php echo I('name');?>" /></th>
		<th>    				
		...
		<th>
			<a class="btn btn-primary" href="javascript:;" id="search" url="<?php echo U('Config/index');?>">查询</a>
		</th>
	</thead>
</table>	
	...
	<div class="col-xs-12">	
		<div class="table-responsive">
			<table class="table table-striped table-bordered table-hover">
				...
				<tbody>
						<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$c): $mod = ($i % 2 );++$i;?><tr>							
							<td><?php echo ($c["name"]); ?></td>
							<td><?php echo ($c["config_group"]); ?></td>
							<td><?php echo ($c["value"]); ?></td>		
							<td><?php echo ($c["info"]); ?></td>						
							<td>
								<a  class="btn btn-xs btn-info" href='<?php echo U("Config/edit",array("id"=>$c["id"]));?>'>
									<i class="icon-edit bigger-120"></i>
								</a> 
								<a class="delete btn btn-xs btn-danger" href='<?php echo U("Config/del",array("id"=>$c["id"]));?>' >
