...
<html lang="en">
	...
	<span class="btn btn-primary">用户行为</span>
	</div>	
	...
	<div class="col-xs-12">	
		<div class="table-responsive">
			<table class="table table-striped table-bordered table-hover">
				...
				<tbody>
						<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$ua): $mod = ($i % 2 );++$i;?><tr>							
							<td><?php echo ($ua["uname"]); ?></td>
							<td><?php echo ($ua["type"]); ?></td>
							<td><?php echo ($ua["info"]); ?></td>							
							<td><?php echo ($ua["add_time"]); ?></td>							
