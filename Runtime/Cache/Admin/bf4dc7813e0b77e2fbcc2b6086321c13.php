...
<html lang="en">
	...
	<a href="<?php echo U('Transport/add');?>" class="btn btn-primary">新增</a>
...
<div class="row">
	<div class="col-xs-12">	
		...
		<div class="table-responsive">
			...
			<?php $unit=get_weight_name(C('WEIGHT_ID')); ?>	
...
$(function(){	
	$('a[class="J_Delete ncsc-btn-mini"]').click(function(){
		...
		if(f){
			$(this).attr('href','<?php echo U("Transport/del");?>'+'/id/'+id);
			return true;	
		}else{
			return false;
		}
	...
	$('a[class="J_Modify ncsc-btn-mini"]').click(function(){
		var id = $(this).attr('data-id');
		if(typeof(id) == 'undefined') return false;
		$(this).attr('href','<?php echo U("Transport/edit");?>'+'/id/'+id);
		return true;
	});
	...
	$('a[class="J_Clone ncsc-btn-mini"]').click(function(){
		var id = $(this).attr('data-id');
		if(typeof(id) == 'undefined') return false;
		$(this).attr('href','<?php echo U("Transport/clone_data");?>'+'/id/'+id);
		return true;
	});
