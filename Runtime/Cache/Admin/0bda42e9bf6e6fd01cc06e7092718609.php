...
<script src="/theguide/Common/ztree/jquery.ztree.all-3.5.min.js"></script>
<link  rel="stylesheet" type="text/css" href="/theguide/Common/ztree/zTreeStyle.css" />
<link  rel="stylesheet" type="text/css" href="/theguide/Common/ztree/demo.css" />	
	...
	$('.J_SubmitPL').click(function(e){    	
    	...
    	var zTree = $.fn.zTree.getZTreeObj("menu_tree"),
			...
			if($("input[name='action']").val()=='add'){
				url='<?php echo U("Menu/add");?>';
			}else if($("input[name='action']").val()=='edit'){
				url='<?php echo U("Menu/edit");?>';
			}
