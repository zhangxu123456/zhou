...
<div class="page-header">
	<a href="<?php echo U('News/add');?>" class="btn btn-primary" >新增</a>
</div>
			...
			<table class="table table-striped table-bordered table-hover">
				...
				<tbody>
						<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>						
							...
							<td><img src="/theguide/<?php echo ($data["image"]); ?>" /></td>
							<td><?php echo ($data["title"]); ?></td>
							<!-- <td><?php echo ($data["ctitle"]); ?></td> -->
							<!-- <td>
								<?php switch($data["status"]): case "1": ?><span class="green bold">是</span><?php break;?>    
									<?php case "0": ?><span class="red bold">否</span><?php break; endswitch;?>
							</td> -->
							<!-- <td>
								<?php switch($data["allow_reply"]): case "1": ?><span class="green bold">是</span><?php break;?>    
									<?php case "0": ?><span class="red bold">否</span><?php break; endswitch;?>
							</td> -->

							<td><?php echo ($data["date"]); ?></td>
							<td>
								<a  class="btn btn-xs btn-info" href='<?php echo U("News/edit",array("id"=>$data["news_id"]));?>'>
									<i class="icon-edit bigger-120"></i>
								</a> 
								<a class="delete btn btn-xs btn-danger" href='<?php echo U("News/del",array("id"=>$data["news_id"]));?>' >
