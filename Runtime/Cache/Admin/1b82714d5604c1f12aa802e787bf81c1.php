          	...
          	<!-- 常规 START -->
	          	<div class="tab-pane active" id="tab-general">
					...
					<div class="form-group">
	                    ...
	                    <div class="col-sm-10">
	                      <textarea name="goods_description[summary]" id="summary" class="form-control" rows="5"><?php echo ((isset($description["summary"]) && ($description["summary"] !== ""))?($description["summary"]):''); ?></textarea>	
	                    </div>
                  	</div>
	          	...
	          	<div class="tab-pane" id="tab-data">
	          		...
	          		<div class="form-group required">
		                ...
		                <div class="col-sm-10" id="thumb">
		                  	<a href="#" data-toggle="image" class="img-thumbnail">
		                  		<img osctype="image" <?php if($goods['image']): ?>src="/theguide/<?php echo ($goods["thumb_image"]); ?>" 
								<?php else: ?> 
		            ...
		            <div class="form-group required">
						<label class="col-sm-2 control-label" for="input-meta-title2">商品描述：</label>
						<div class="col-sm-10">
							<input id="input-meta-title2" class="form-control" type="text" placeholder="商品描述" value="<?php echo ((isset($goods["ms"]) && ($goods["ms"] !== ""))?($goods["ms"]):''); ?>" name="ms">
						</div>
					</div> 
	          	...
	          	<div class="tab-pane" id="tab-discount">
	          		<div class="table-responsive">
		                ...
		                <div>
		                	<a  onclick="addDiscount();" class="add_image btn btn-primary ">添加折扣</a>
		                </div>
                	</div>
	          	</div>
	          	<!--折扣 END -->
                            ...
                            <tr id="option-value-row<?php echo $option_value_row; ?>">
                              ...
                              <?php }else{ ?>
                              	<td class="text-left">
                              		...
                              		<img osctype="option_image<?php echo $option_value_row; ?>" src="<?php if(!empty($goods_option_value['image'])){echo resize($goods_option_value['image'],100,100);}else{ echo '/theguide/Common/image/no_image_100x100.jpg'; } ?>" alt="" title="" />
...
<script src="/theguide/Common/ckeditor/ckeditor.js"></script> 
...
$('#goods-category').delegate('.icon-ban-circle', 'click', function() {
	...
	function addImage() {
		...
		html += '  <td class="text-left"><a href="#" id="thumb-image' + image_row + '"data-toggle="image" type="gallery" num="'+image_row+'" class="img-thumbnail"><img osctype="gallery_image'+image_row+'" src="/theguide/Common/image/no_image_100x100.jpg" alt="" title="" /><input osctype="gallery_image_input'+image_row+'" type="hidden" name="goods_image[' + image_row + '][image]" value="" id="input-image' + image_row + '" /></td>';
